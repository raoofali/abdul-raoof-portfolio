  ...
  return (
    <Reveal key={project.slug} delay={delay}>
      <article className="grid gap-4 lg:grid-cols-5">
        ...
        <div className="card-surface flex h-90vh flex-col overflow-hidden">
          {activeScreenshot ? (
            ...
            <div className="mt-4 grid grid-cols-4 gap-1">
              {screenshots.map((screenshot, index) => (
                <button
                  ...
                  className={`overflow-hidden rounded-md border transition duration-200 focus:outline-none focus:ring-2 focus:ring-accent/50 ${
                    index === activeIndex
